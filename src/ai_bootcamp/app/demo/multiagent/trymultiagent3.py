#!/usr/bin/env python3
"""
멀티에이전트 시스템 - Azure OpenAI 기반 Supervisor 워커 관리
참조 소스를 기반으로 한 Azure OpenAI 멀티에이전트 구현
"""
...
def main():
    """메인 함수"""
    logger.info("IN: main() - Azure OpenAI 멀티에이전트 시스템 시작")
    ...
    try:
        ...
        print("=" * 70)
        print("🎯 Azure OpenAI 멀티에이전트 시스템 - Supervisor 기반 워커 관리")
        print("=" * 70)
        print("💡 워커 구성:")
        ...
        while True:
            try:
                ...
                if user_input.upper() == "END":
                    ...
                    print("\n👋 Azure OpenAI 멀티에이전트 시스템을 종료합니다. 감사합니다!")
                    break
